...
function loadConfig(branch, repoConfig, options) {
  const pathToConfigRelative = repoConfig.settingsConfig.path || 'config';
...
module.exports = (strategy) => {
  ...
  strategy.create = (branch, options) => {
    ...
    repoConfig.settingsConfig = repoConfig.settingsConfig || {};
    repoConfig.settingsConfig.config = loadConfig(branch, repoConfig, options);
